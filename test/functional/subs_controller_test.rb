...
class SubsControllerTest < ActionController::TestCase
  ...
  test "should create sub" do
    assert_difference('Sub.count') do
      post :create, sub: { eTime: @sub.eTime, projectId: @sub.projectId, sTime: @sub.sTime, source: @sub.source, sourceLang: @sub.sourceLang, trans: @sub.trans, transLang: @sub.transLang }
    end
  ...
  test "should update sub" do
    put :update, id: @sub, sub: { eTime: @sub.eTime, projectId: @sub.projectId, sTime: @sub.sTime, source: @sub.source, sourceLang: @sub.sourceLang, trans: @sub.trans, transLang: @sub.transLang }
    assert_redirected_to sub_path(assigns(:sub))
  end
